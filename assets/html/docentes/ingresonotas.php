...
<div class="body">
    <div class="panel">
           ...
           if(!isset($_GET['revisar'])){
            ...
            <form method="get" class="form" action="ingresonotas.php">
                ...
                <?php foreach ($cursos as $curso):?>
                    <input type="radio" name="curso" required value="<?php echo $curso['id'] ?>">Curso <?php echo $curso['curso'] ?>
                <?php endforeach;?>

                <br><br>
                <button type="submit" name="revisar" value="1">Ingresar Notas</button> <a class="btn-link" href="consultanotas.php">Consultar Notas</a>
                <br><br>
            </form>
        <?php
           }
        ...
        if(isset($_GET['revisar'])){
            ...
            ?>
            <br>
            <a href="ingresonotas.php"><strong><< Volver</strong></a>
            <br>
            <br>
            ...
            <table class="table" cellpadding="0" cellspacing="0">
                ...
                <?php foreach ($alumnos as $index => $alumno) :?>
                    ...
                    <input type="hidden" value="<?php echo $alumno['identificacion'] ?>" name="<?php echo 'id_alumno'.$index ?>">
                    <input type="hidden" value="<?php echo $num_eval ?>" name="cantidad_notas">
                    ...
                    <tr>
                        ...
                        <?php
                           if(existeNota($alumno['identificacion'],$id_materia,$conn) > 0){
                        ...
                        if(existeNota($alumno['identificacion'],$id_materia,$conn) > 0){
                            echo '<td><a href="notadelete.php?idalumno='.$alumno['identificacion'].'&idmateria='.$id_materia.'">Eliminar</a> </td>';
                        }else{
                ...
                <br>
                <button type="submit" name="insertar">Guardar</button> <button type="reset">Limpiar</button> <a class="btn-link" href="consultanotas.php">Consultar Notas</a>
                <br>
        </form>
