...
$sql="SELECT a.identificacion, a.nombres, a.apellidos, a.direccion, a.telefono_celular, a.rh, a.f_nacimiento, a.estrato, a.eps, b.nombre as grado from estudiantes as a inner join grados as b on a.id_grado = b.id" ;
        ...
        <div class="perfil-usuario-body">
            ...
            <div class="perfil-usuario-footer">
                <ul class="lista-datos">
                    ...
                    <li><i class="icono fas fa-phone-alt"></i> Telefono: <?php echo $row['telefono_celular'] ?></li>
