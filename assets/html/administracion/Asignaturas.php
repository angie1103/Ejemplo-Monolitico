    ...
    <body id="body">
        <div class="navigation">
            ...
            <script>
                ...
                <main>
                    <h1 style="text-align: center;">Configuracion De Asignaturas</h1>

                    <div class="container__box">
                        <div class="box">
                            <a href="materias/crearmaterias.php"><i class="fa fa-book"></i></a>
                            <h5 >Nueva Materia</h5>
                            <h4 >Nueva Materia</h4>
                        </div>
                        <div class="box">
                            <a href="materias/consultarmaterias.php"><i class="fa fa-search"></i></a>
                            <h5> Consultar Materias existentes</h5>
                            <h4>Consultar Materias existentes</h4>
                        </div>
